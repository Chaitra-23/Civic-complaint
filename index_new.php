...
// Include header which contains database connection
...
if (!$conn) {
    echo "<div class='alert alert-danger'>Database connection failed on index.php</div>";
...
<div class="container mb-5">
    ...
    <div class="alert alert-info">
        ...
        <p>Stats array: <?php echo json_encode($stats); ?></p>
    </div>
    <?php endif; ?>
