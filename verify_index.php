...
if (!$conn) {
    ...
    // Display the HTML that would be generated in index.php
    echo "<h2>HTML Output:</h2>";
    echo "<div style='display: flex; justify-content: space-between;'>";
    echo "<div><strong>Total Complaints:</strong> <span style='font-size: 24px;'>" . $stats['total'] . "</span></div>";
    echo "<div><strong>Resolved Issues:</strong> <span style='font-size: 24px;'>" . $stats['resolved'] . "</span></div>";
    echo "<div><strong>Departments:</strong> <span style='font-size: 24px;'>" . $stats['departments'] . "</span></div>";
    echo "<div><strong>Registered Users:</strong> <span style='font-size: 24px;'>" . $stats['users'] . "</span></div>";
    echo "</div>";
}
?>